...
namespace tinhdahinh
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (hinh == 1)
            {
                tugiac tg = new TamGiac(3);
                tg.Xuat();
            }
            else if (hinh == 2)
            {
                tugiac tg = new HinhTuGiac(4);
                tg.Xuat();
            }
            else if (hinh == 3)
            {
                tugiac tg = new HinhBinhHanh(4);
                tg.Xuat();
            }
            else if (hinh == 4)
            {
                tugiac tg = new HinhChuNhat(4);
                tg.Xuat();
            }
            else if (hinh == 5)
            {
                tugiac tg = new HinhVuong(4);
                tg.Xuat();
            }
            else
            {
